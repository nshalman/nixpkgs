...
stdenv.mkDerivation (finalAttrs: {
  ...
  # illumos: int8_t is a plain char there, and the conversion tests cannot convert json to it
  doCheck = stdenv.buildPlatform.canExecute stdenv.hostPlatform && !stdenv.hostPlatform.isSunOS;

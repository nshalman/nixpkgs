...
#
# Test: ./test-smf-lib.sh (svccfg validate + scratch-repo import/export
...
rec {
    ...
    let
      ...
      lines =
        [
          ...
          "     zone-root/services.nix. Do not edit the XML; edit the nix. -->"
  ...
  # zone-root/builder.sh can import everything in one directory glob.
  mkSmfManifestBundle =
    {
      name ? "smf-manifests",
      manifests,
